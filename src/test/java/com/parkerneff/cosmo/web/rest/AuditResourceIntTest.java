package com.parkerneff.cosmo.web.rest;

import com.parkerneff.cosmo.CosmoApp;
import com.parkerneff.cosmo.config.audit.AuditEventConverter;
import com.parkerneff.cosmo.domain.PersistentAuditEvent;
import com.parkerneff.cosmo.repository.PersistenceAuditEventRepository;
import com.parkerneff.cosmo.service.AuditEventService;
...
@SpringBootTest(classes = CosmoApp.class)
@Transactional
